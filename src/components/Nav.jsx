...
const Nav = () => {
    const navItems = <>
        ...
        <li className='cursor-pointer hover:font-bold'><Link to='projects' smooth={true} duration={1000}>Projects</Link></li>
        ...
        <li className='cursor-pointer hover:font-bold'><Link to='contact' smooth={true} duration={1000}>Contact me</Link></li>
    </>
